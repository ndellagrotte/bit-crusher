...
| `sampleRateDivisor` | 3 | 1–8 | Divides the effective sample rate by holding samples. Every sound ends up at 44100 / this Hz, whatever rate its file uses, so a mod's 192 kHz sounds get crushed as much as vanilla's. 1 leaves the rate alone. |
